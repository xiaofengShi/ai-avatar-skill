...
for (const [source, target, title] of [
  ...
  if (source === 'SHOWCASE.md') {
    ...
    body = `<section class="hero">${intro}<div class="actions"><a class="primary" href="#examples">浏览案例 ↓</a><a href="https://github.com/xiaofengShi/ai-avatar-skill/blob/main/README.zh-CN.md">开始使用 ↗</a></div></section>` + body.slice(introEnd);
