...
img{max-width:100%;height:auto;display:block;margin:12px auto;border-radius:8px}table{border-collapse:collapse;width:100%;table-layout:fixed}
td,th{padding:8px;text-align:left;border-bottom:1px solid #cbd4cb;vertical-align:top}td img{width:100%}
...
@media print{body{background:white}main{padding:0}h2,h3{break-after:avoid}tr{break-inside:avoid}img{max-height:85mm;width:auto}pre{white-space:pre-wrap;overflow-wrap:anywhere}}
`;
