...
**Seven cases, organized by purpose.** The travel illustration uses a real photo whose owner approved public display of this case and liked the result. The other six cases cover three AI-generated fictional people. Codex's built-in image tool produced every final image. Source and result are shown at equal size; open either image to inspect it at full resolution.
...
| **Haimati-inspired ID-style portrait**<br>Fictional Chinese woman · résumé / staff profile<br>Casual source → polished studio photo | [<img class="studio-id" src="examples/studio-id-photo/source.png" alt="AI-generated casual source photo of a fictional Chinese woman" width="220">](examples/studio-id-photo/source.png) | [<img class="studio-id" src="examples/studio-id-photo/portrait.png" alt="Polished ID-style studio portrait of the same fictional woman" width="220">](examples/studio-id-photo/portrait.png) | Frontal head-and-shoulders framing, pale blue background, navy blazer, and restrained styling. Hair and the left-cheek beauty mark remain visible; facial details still shift in generation. **AI demonstration only, unaffiliated with Haimati and unverified for official documents.**<br>[Request](examples/studio-id-photo/request.txt) · [Source prompt](examples/studio-id-photo/source.prompt.txt) · [Portrait prompt](examples/studio-id-photo/generation.prompt.txt) |
...
Examples made from 2026-09-21 to 2026-09-24. Each of the six fictional-character cases had one initial generation. The smile case then received one correction after user feedback. The first travel call failed to read a JPEG and produced no image; after conversion to PNG, the same brief produced one result. The travel case also used a style image from an earlier conversation. Permission to redistribute that image was not granted, so it is not in this repository and is not a bundled public style reference. The new studio ID-style case demonstrates a photographic direction; it has not been checked against any official document's size, background, or retouching rules.
