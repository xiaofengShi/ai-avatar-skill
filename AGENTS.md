...
- Docs: `npm ci && npm run build:docs`; README covers usage; SHOWCASE.md is the homepage content source; VALIDATION.md is the validation source. HTML is generated; homepage layout lives in scripts/showcase.html. Run `npm run check:docs` before committing docs changes.
